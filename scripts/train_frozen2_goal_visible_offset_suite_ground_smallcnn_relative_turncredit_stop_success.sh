...
EXPNAME="${EXPNAME:-exp_frozen2_goal_visible_offset_suite_ground_smallcnn_relative_turncredit_stop_success_80k}"
...
bash "${SCRIPT_DIR}/train_frozen2_goal_visible_offset_ground_smallcnn_relative_turncredit_stop_success.sh" \
