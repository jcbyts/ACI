...
MODEL_PATH="${MODEL_PATH:-logs/2026-06-11/exp_frozen2_goal_ground_smallcnn_contact_fast_80k/best_model}"
TOTAL_TIMESTEPS="${TOTAL_TIMESTEPS:-50000}"
N_ENVS="${N_ENVS:-1}"
N_STEPS="${N_STEPS:-512}"
BATCH_SIZE="${BATCH_SIZE:-64}"
EVAL_FREQ="${EVAL_FREQ:-5000}"
EXPNAME="${EXPNAME:-exp_frozen2_goal_ground_smallcnn_contact_resume_50k}"
RENDER="${RENDER:-true}"
